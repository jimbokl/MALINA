...
- **Инструмент → понимание → сорт:** `/instrumenty/` объединяет подбор, расчёт саженцев, проверку глубины посадки и обрезку. Проверка посадки ведёт к исходным руководствам, материалу о посадке и расчёту; помощник по обрезке — к материалу или каталогу; расчёт саженцев — к подбору. Неизвестные сведения не превращаются в уверенный совет.
