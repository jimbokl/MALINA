...
- **Инструмент → понимание → сорт:** помощник по обрезке начинает с проверенного типа плодоношения и ведёт к подробному материалу или каталогу; расчёт саженцев использует размеры и шаги посетителя, затем ведёт к подбору. Неизвестные сведения не превращаются в уверенный совет.
