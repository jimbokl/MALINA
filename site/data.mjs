...
export const varieties = [
  ...
  },
  {
    ...
    type: 'Тип плодоношения не подтверждён', period: 'Срок созревания не указан в записи реестра', place: 'Условия выращивания не указаны в записи реестра',
    note: 'В Госреестре 2024 года «Фестивальная» указана с допуском для регионов 1–11. Это официальный допуск, а не прогноз зимовки, срока созревания или урожая на отдельном участке.',
    traits: ['Регионы допуска 1–11 · 2024', 'Срок созревания и урожайность по этой записи неизвестны', 'Местные результаты нужно проверять отдельно'],
